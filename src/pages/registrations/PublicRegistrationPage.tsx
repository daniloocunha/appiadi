...
export function PublicRegistrationPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Header */}
      <div className="bg-amber-900 text-white px-4 py-5 text-center">
        ...
        <p className="text-xs text-amber-200">Gestão de Membros</p>
      </div>
          ...
          <button
            ...
            className={[
              ...
              isSubmitting
                ...
                : 'bg-amber-900 hover:bg-amber-800 active:bg-amber-950',
            ].join(' ')}
          >
